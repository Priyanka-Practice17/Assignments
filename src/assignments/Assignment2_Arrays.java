package assignments;
	...
	public class Assignment2_Arrays {
		...
		public static void main(String[] args) {
			...
			String[][]Sem1={Semesters,Subjects,Subject1};
			String[][]Sem3={Semesters,Subjects,Subject3};
			String[][]Sem4= {Semesters,Status4_Marks4,Subject4};
			
			String[][][]CollegeMarks= {Sem2,Sem4};
			String[][][]HalfyearMArks= {Sem1,Sem3};
			
			String[][][][]Acamedicyear= {HalfyearMArks,CollegeMarks};
